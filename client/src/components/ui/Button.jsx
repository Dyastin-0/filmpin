...
const variants = {
	default: 'p-2 text-primary-foreground rounded-md transition-all duration-300 focus:bg-primary-highlight focus:text-primary-highlight-foreground hover:bg-primary-highlight hover:text-primary-highlight-foreground',
