...
export const ImageDummy = () => (
  <motion.div
    className="rounded-md w-full h-[250px] bg-secondary"
...
export const TitleDummy = () => (
  <motion.div
    className="rounded-md w-full h-[20px] bg-secondary"
    variants={blinkVariants}
    animate="blink"
  />
);
export const YearDummy = () => (
  <motion.div
    className="rounded-md w-1/2 h-[15px] bg-secondary"
    variants={blinkVariants}
    animate="blink"
  />
);
export const GenresDummy = () => (
  <motion.div
    className="rounded-md w-1/3 h-[10px] bg-secondary"
    variants={blinkVariants}
    animate="blink"
  />
);
...
export const LoadingSearchResult = ({ title }) => (
  <div className="flex flex-col bg-primary rounded-lg gap-4 p-4 items-center h-full w-full">
    <h1 className="text-primary-foreground pb-4 text-sm w-full font-semibold">
      {title}
    </h1>
