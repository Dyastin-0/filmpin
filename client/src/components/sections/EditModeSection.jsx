...
const EditModeSection = ({ handleSave, toggleEditMode }) => {
  return (
    <div className="flex justify-end items-center gap-2 w-full">
      <div className="flex flex-col gap-2 w-full items-center text-xs text-primary-foreground">
        ...
        <span>
          Tip: drag and drop to reorder items in the list; the first item in the
          list will be the list's backdrop; the first four items will be
